...
function showVideo() {
  ...
  if (window.AresIframeReload && typeof window.AresIframeReload.stop === 'function') {
    window.AresIframeReload.stop();
  } else if (iframeEl) {
    iframeEl.src = 'about:blank';
  }
...
function playEntryAsOverlay(entry) {
  ...
  if (
    ...
    typeof window.AresIframeReload.isLovetierUrl === 'function' &&
    window.AresIframeReload.isLovetierUrl(url)
  ) {
    window.AresIframeReload.play(url);
  } else {
    if (window.AresIframeReload && typeof window.AresIframeReload.stop === 'function') {
      window.AresIframeReload.stop();
    }
