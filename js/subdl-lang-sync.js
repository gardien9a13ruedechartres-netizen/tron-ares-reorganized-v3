...
(function () {
  ...
  function attachListenersOnce() {
    ...
    var mo = new MutationObserver(function () {
      ...
      if (isOverlayOpen()) {
        ...
        // Petit "re-sync" différé (au cas où js/tron-ares.js réécrit après)
  ...
  function boot() {
    // Attendre que les éléments existent (js/tron-ares.js peut construire après)
    var tries = 0;
